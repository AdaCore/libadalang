...
with Libadalang.Target_Info_Native;
...
package body Libadalang.GPR_Impl is
   ...
   begin
      ...
      --  We found no relevant target information: return target information
      --  for known targets, or make sure OUT arguments are initialized for
      --  other targets.

      Target_Info_Native.Get_Builtin_Target_Info
        (String (Tree.Target (Canonical => True)),
         Target_Info,
         Has_Target_Info);
