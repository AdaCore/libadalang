# -*- coding: utf-8 -*-
#
# libadalang documentation build configuration file, created by
...
import libadalang
if libadalang.version:
    version = libadalang.version
    release = (f"{version}-{libadalang.build_date}"
               if libadalang.build_date else
               version)
...
htmlhelp_basename = 'libadalangdoc'
...
epub_copyright = u'2014-2022, AdaCore'
