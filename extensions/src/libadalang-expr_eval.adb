                  ...
                  begin
                     ...
                     then
                        ...
                        then
                           ...
                           --  return here the evaluation done by the GNAT
                           --  compiler that has been used to build this
                           --  source.

                           if AR.P_Std_Char_Type = Range_Type
                           then
                              Result.Set
                                (GNATCOLL.GMP.Long (Character'Range_Length));
                           elsif AR.P_Std_Wide_Char_Type = Range_Type
                           then
                              Result.Set
                                (GNATCOLL.GMP.Long
                                  (Wide_Character'Range_Length));
                           else
                              Result.Set
                                (GNATCOLL.GMP.Long
                                  (Wide_Wide_Character'Range_Length));
                           end if;
                        else
                           declare
