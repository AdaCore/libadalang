...
package body Libadalang.GPR_Impl is
   ...
   begin
      ...
      --  The default runtimes for native targets lack "ada_target_properties"
      --  files. For convenience, provide sane values for them here.
            ...
            Target_Info :=
              (Bits_BE                    => False,
               ...
               Double_Scalar_Alignment    =>
                 (if Target = Linux_32 then 4 else 0),
               Double_Size                => 64,
               Float_Size                 => 32,
               ...
               Long_Long_Size             => 64,
               Long_Size                  =>
                 (if Target = Linux_64 then 64 else 32),
