...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION__QUEX___EASYLEXER
...
#define QUEX_SETTING_BUILD_DATE        "Mon Jun 30 18:21:09 2014"
...
#   define QUEX_FUNCTION_PREFIX        quex_EasyLexer_
#   define QUEX_FUNCTION_DEF_PREFIX    quex_EasyLexer_
    /* In 'C' there are no namespaces, so namespaces are coded directly
     * into the type name. Both, global and local names are equal.       */
#   define QUEX_TYPE0_ANALYZER         struct quex_EasyLexer_tag
#   define QUEX_TYPE_ANALYZER          struct quex_EasyLexer_tag
#   define QUEX_NAME_COMPLETE_ANALYZER quex_EasyLexer
#   define QUEX_TYPE_DERIVED_ANALYZER  struct quex_EasyLexer_tag
...
#   define QUEX_NAMESPACE_MAIN         quex_EasyLexer
...
#   define QUEX_NAME(NAME)             quex_EasyLexer_ ## NAME
...
#   define QUEX_FUNCTION_PREFIX_BACKUP       quex_EasyLexer_
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   quex_EasyLexer_

#else
#   define QUEX_FUNCTION_DEF_PREFIX    /* Supposed we are IN the namespace for definition. */
#   define QUEX_FUNCTION_PREFIX        que::
    /* Add namespaces for the global names of the classes of analyzer
     * and token.                                                        */
#   define QUEX_TYPE0_ANALYZER         EasyLexer
#   define QUEX_TYPE_ANALYZER          que::EasyLexer
#   define QUEX_NAME_COMPLETE_ANALYZER que::EasyLexer
#   define QUEX_TYPE_DERIVED_ANALYZER  EasyLexer

#   define QUEX_TYPE0_TOKEN            Token
#   define QUEX_TYPE_TOKEN             que::Token
#   define QUEX_NAME_COMPLETE_TOKEN    que::Token

#   define QUEX_NAMESPACE_MAIN         que
#   define QUEX_NAMESPACE_MAIN_OPEN    namespace quex {\

#   define QUEX_NAMESPACE_MAIN_CLOSE   } /* Closing Namespace 'quex' */\


#   define QUEX_NAMESPACE_TOKEN        que
...
#   define QUEX_NAME(NAME)             EasyLexer_ ## NAME
#   define QUEX_NAME_TOKEN(NAME)       Token_ ## NAME
#   define QUEX_MEMBER(NAME)           EasyLexer::NAME                
    /* When creating a 'shared token class', macros are temporarily redefined.
     * This happens to generate converters in the token's namespace. After 
     * that, the original macros need to be restored. Thus: Backup!          */  
...
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   que::
#endif
