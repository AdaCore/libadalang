package Std_Sizes_Linux_64 is
   ...
   pragma Compile_Time_Error
     (Long_Long_Float'Size /= 128, "Long_Long_Float'Size");
   pragma Compile_Time_Error
     (Short_Integer'Size /= 16, "Short_Integer'Size");
   pragma Compile_Time_Error
     (Integer'Size /= 32, "Integer'Size");
   pragma Compile_Time_Error
     (Long_Integer'Size /= 64, "Long_Integer'Size");
   pragma Compile_Time_Error
     (Long_Long_Integer'Size /= 64, "Long_Long_Integer'Size");
   pragma Compile_Time_Error
     (Long_Long_Long_Integer'Size /= 128, "Long_Long_Long_Integer'Size");
end Std_Sizes_Linux_64;
