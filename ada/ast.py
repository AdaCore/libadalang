...
class AdaNode(ASTNode):
    ...
    def withed_unit_helper(unit_name=T.Name):
        ...
        dummy = Var(Cond(
            ...
            Self.designated_compilation_unit(
                unit_name.as_symbol_array, kind=UnitSpecification,
...
class BasicDecl(AdaNode):
    ...
    def body_part_for_decl():
        ...
        If ``not_found_is_error``, and the decl is a library unit, then the
        ``Unit_Requested``  callback will be called with the eponym parameter
        being true.
