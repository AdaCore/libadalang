# Test the behavior of the p_entities property on various expressions involving
# overloaded functions that return records and field accesses on the returned
# records.
